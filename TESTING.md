...
- https://validator.w3.org/nu/?doc=https://Rubina1978.github.io/roam-ready/index.html
...
| destinations | [home.html](https://github.com/Rubina1978/roam-ready/blob/main/destinations/templates/destinations/home.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-destinations-home.png) | ⚠️ Notes (if applicable) |
...
| templates | [logout.html](https://github.com/Rubina1978/roam-ready/blob/main/templates/account/logout.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-logout.png) | ⚠️ Notes (if applicable) |
| templates | [password_reset.html](https://github.com/Rubina1978/roam-ready/blob/main/templates/account/password_reset.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-password_reset.png) | ⚠️ Notes (if applicable) |
| templates | [password_reset_done.html](https://github.com/Rubina1978/roam-ready/blob/main/templates/account/password_reset_done.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-password_reset_done.png) | ⚠️ Notes (if applicable) |
| templates | [password_reset_from_key.html](https://github.com/Rubina1978/roam-ready/blob/main/templates/account/password_reset_from_key.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-password_reset_from_key.png) | ⚠️ Notes (if applicable) |
| templates | [password_reset_from_key_done.html](https://github.com/Rubina1978/roam-ready/blob/main/templates/account/password_reset_from_key_done.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-password_reset_from_key_done.png) | ⚠️ Notes (if applicable) |
| templates | [signup.html](https://github.com/Rubina1978/roam-ready/blob/main/templates/account/signup.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-signup.png) | ⚠️ Notes (if applicable) |
| templates | [verification_sent.html](https://github.com/Rubina1978/roam-ready/blob/main/templates/account/verification_sent.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-verification_sent.png) | ⚠️ Notes (if applicable) |
...
- https://jigsaw.w3.org/css-validator/validator?uri=https://roamready-8bd1c197ca5b.herokuapp.com
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| static | [style.css](https://github.com/Rubina1978/roam-ready/blob/main/static/css/style.css) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/css-static-style.png) | ⚠️ Notes (if applicable) |
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| destinations | [admin.py](https://github.com/Rubina1978/roam-ready/blob/main/destinations/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Rubina1978/roam-ready/main/destinations/admin.py) | ![screenshot](documentation/validation/py-destinations-admin.png) | ⚠️ Notes (if applicable) |
| destinations | [forms.py](https://github.com/Rubina1978/roam-ready/blob/main/destinations/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Rubina1978/roam-ready/main/destinations/forms.py) | ![screenshot](documentation/validation/py-destinations-forms.png) | ⚠️ Notes (if applicable) |
| destinations | [models.py](https://github.com/Rubina1978/roam-ready/blob/main/destinations/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Rubina1978/roam-ready/main/destinations/models.py) | ![screenshot](documentation/validation/py-destinations-models.png) | ⚠️ Notes (if applicable) |
| destinations | [tests.py](https://github.com/Rubina1978/roam-ready/blob/main/destinations/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Rubina1978/roam-ready/main/destinations/tests.py) | ![screenshot](documentation/validation/py-destinations-tests.png) | ⚠️ Notes (if applicable) |
| destinations | [urls.py](https://github.com/Rubina1978/roam-ready/blob/main/destinations/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Rubina1978/roam-ready/main/destinations/urls.py) | ![screenshot](documentation/validation/py-destinations-urls.png) | ⚠️ Notes (if applicable) |
| destinations | [views.py](https://github.com/Rubina1978/roam-ready/blob/main/destinations/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Rubina1978/roam-ready/main/destinations/views.py) | ![screenshot](documentation/validation/py-destinations-views.png) | ⚠️ Notes (if applicable) |
|  | [manage.py](https://github.com/Rubina1978/roam-ready/blob/main/manage.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Rubina1978/roam-ready/main/manage.py) | ![screenshot](documentation/validation/py--manage.png) | ⚠️ Notes (if applicable) |
| roamready | [forms.py](https://github.com/Rubina1978/roam-ready/blob/main/roamready/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Rubina1978/roam-ready/main/roamready/forms.py) | ![screenshot](documentation/validation/py-roamready-forms.png) | ⚠️ Notes (if applicable) |
| roamready | [settings.py](https://github.com/Rubina1978/roam-ready/blob/main/roamready/settings.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Rubina1978/roam-ready/main/roamready/settings.py) | ![screenshot](documentation/validation/py-roamready-settings.png) | ⚠️ Notes (if applicable) |
| roamready | [urls.py](https://github.com/Rubina1978/roam-ready/blob/main/roamready/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Rubina1978/roam-ready/main/roamready/urls.py) | ![screenshot](documentation/validation/py-roamready-urls.png) | ⚠️ Notes (if applicable) |
...
Alternatively, an improved way to manage bugs is to use the built-in **[Issues](https://www.github.com/Rubina1978/roam-ready/issues)** tracker on your GitHub repository. This can be found at the top of your repository, the tab called "Issues".
...
[![GitHub issue custom search](https://img.shields.io/github/issues-search/Rubina1978/roam-ready?query=is%3Aissue%20is%3Aclosed%20label%3Abug&label=Fixed%20Bugs&color=green)](https://www.github.com/Rubina1978/roam-ready/issues?q=is%3Aissue+is%3Aclosed+label%3Abug)

I've used [GitHub Issues](https://www.github.com/Rubina1978/roam-ready/issues) to track and manage bugs and issues during the development stages of my project.

All previously closed/fixed bugs can be tracked [here](https://www.github.com/Rubina1978/roam-ready/issues?q=is%3Aissue+is%3Aclosed+label%3Abug).
...
[![GitHub issue custom search](https://img.shields.io/github/issues-search/Rubina1978/roam-ready?query=is%3Aissue%2Bis%3Aopen%2Blabel%3Abug&label=Unfixed%20Bugs&color=red)](https://www.github.com/Rubina1978/roam-ready/issues?q=is%3Aissue+is%3Aopen+label%3Abug)

Any remaining open issues can be tracked [here](https://www.github.com/Rubina1978/roam-ready/issues?q=is%3Aissue+is%3Aopen+label%3Abug).
